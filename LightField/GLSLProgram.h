...
public:
	...
	void   compileShader(const std::string fileName) throw (...);
	void   compileShader(const std::string fileName, GLSLShader::GLSLShaderType type, const std::string header = "") throw (...);
